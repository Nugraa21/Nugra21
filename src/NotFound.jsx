    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-100 to-yellow-100 text-gray-900 px-4 sm:px-6 md:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-orange-600 mb-4 sm:mb-6" data-aos="fade-up" data-aos-duration="1000">
            404 - Halaman Tidak Ditemukan
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-700 mb-8 sm:mb-10" data-aos="fade-up" data-aos-duration="1200">
